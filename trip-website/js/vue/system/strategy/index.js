var vue = new Vue({
    ...
    mounted:function () {
        ...
        //查询热门推荐排行:List<StrategyRank>
        ajaxGet("/strategies/ranks", {type:3}, function (data) {
            _this.hotCds = data.data;
        })

        //查询国内推荐排行:List<StrategyRank>
        ajaxGet("/strategies/ranks", {type:2}, function (data) {
            _this.chinaCds = data.data;
        })


        //查询国外推荐排行:List<StrategyRank>
        ajaxGet("/strategies/ranks", {type:1}, function (data) {
            _this.abroadCds = data.data;
        })


        //查询主题： List<StrategyCondition>
        ajaxGet("/strategies/conditions", {type:3}, function (data) {
               _this.themes = data.data;
        })

        //查询国内： List<StrategyCondition>
        ajaxGet("/strategies/conditions", {type:2}, function (data) {
            _this.chinas = data.data;
        })


        //查询国外： List<StrategyCondition>
        ajaxGet("/strategies/conditions", {type:1}, function (data) {
